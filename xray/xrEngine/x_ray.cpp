...
{
	pInput = xr_new<CInput>(!strstr(Core.Params, "-i"));
}
...
#else
	SetWindowPos(logoWindow, HWND_NOTOPMOST, 0, 0, logoRect.right - logoRect.left, logoRect.bottom - logoRect.top, SWP_NOMOVE | SWP_SHOWWINDOW);
#endif // NDEBUG
