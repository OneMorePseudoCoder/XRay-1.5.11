...
void CHW::CreateDevice(HWND m_hWnd, bool move_window)
{
	...
	m_DriverType = Caps.bForceGPU_REF ? D3D10_DRIVER_TYPE_REFERENCE : D3D10_DRIVER_TYPE_HARDWARE;
...
void CHW::updateWindowProps(HWND m_hWnd)
{
	...
	if (bWindowed)		
	{
		if (m_move_window) 
		{
			...
			bool fillDesktop = (m_ChainDesc.BufferDesc.Width == DesktopRect.right - DesktopRect.left) && (m_ChainDesc.BufferDesc.Height == DesktopRect.bottom - DesktopRect.top);
			...
			SetWindowPos(m_hWnd, HWND_TOP, m_rcWindowBounds.left, m_rcWindowBounds.top, (m_rcWindowBounds.right - m_rcWindowBounds.left), (m_rcWindowBounds.bottom - m_rcWindowBounds.top), SWP_SHOWWINDOW | SWP_NOCOPYBITS | SWP_DRAWFRAME);
		}
	}
	else
	{
